...
export function Markets() {
  ...
  async function handleFeatureAsAdminPick() {
    ...
    // Never generated by this platform -- whatever you typed after building
    // the identical slip by hand on a real bookmaker's site. Shown only to
    // premium viewers once saved (see AdminPickCard).
